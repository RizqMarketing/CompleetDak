...
const Hero = () => {
  ...
  const slides = [
    {
      title: "Premium Bouwkwaliteit",
      subtitle: "Vakmanschap en betrouwbaarheid voor uw droomproject",
    ...
    {
      title: "Duurzame Bouwoplossingen",
      subtitle: "Moderne technieken gecombineerd met traditioneel vakmanschap",
      image: "https://images.pexels.com/photos/2360569/pexels-photo-2360569.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop",
      overlay: "from-slate-900/80 via-slate-900/60 to-slate-900/40"
    },
    {
      title: "Renovatie & Verbouwing",
      subtitle: "Transformeer uw ruimte met onze expertise en precisie",
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-32 right-16 w-24 h-24 border border-yellow-400/30 rotate-12 animate-bounce"></div>
        <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-yellow-400/10 rotate-45 animate-pulse"></div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8 sm:mb-12">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight">
              ...
              <span className="block text-white drop-shadow-2xl">EMT</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 sm:mb-16 lg:mb-20 px-4">
            <a 
              href="#contact"
              className="group bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-400 hover:to-yellow-300 text-slate-900 font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-yellow-500/25 flex items-center justify-center space-x-2 text-sm sm:text-base"
            >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-12 sm:mb-16 px-4">
            ...
            >
              ...
              <div className="text-center">
                <div className="font-medium">0488 23 40 37</div>
            ...
            {stats.map((stat, index) => (
              ...
              >
                <div className="flex justify-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-yellow-400 to-yellow-300 rounded-xl flex items-center justify-center shadow-lg">
                    <stat.icon className="w-5 h-5 sm:w-6 sm:h-6 text-slate-900" />
                  </div>
                </div>
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-yellow-400 mb-1 sm:mb-2">{stat.number}</div>
      ...
      <div className="absolute bottom-8 right-4 sm:right-8 flex flex-col space-y-3">
        {slides.map((_, index) => (
          <button
            ...
            className={`w-3 h-6 sm:h-8 rounded-full transition-all duration-300 ${
              index === currentSlide 
      ...
      <div className="absolute bottom-0 left-0 w-full h-1 bg-white/20">
        <div 
          className="h-full bg-gradient-to-r from-yellow-400 to-yellow-300 transition-all duration-7000 ease-linear"
          style={{ 
