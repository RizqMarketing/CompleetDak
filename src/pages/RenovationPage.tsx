...
import { 
  Wrench, CheckCircle, Phone, Mail, ArrowRight, 
  Award, Shield, Clock, Users, Calculator, Eye, Home, Bath, ChefHat,
...
const RenovationPage = () => {
  ...
  const services = [
    "Complete woning renovaties en verbouwingen",
    "Badkamer en keuken renovaties",
    "Dakkapel, uitbouw en opbouw realisatie",
    "Woning modernisering en verduurzaming", 
    "Energiezuinig maken van woningen",
    "Interieur verbouwingen en indeling wijzigen",
    "Funderingsherstel en constructieve aanpassingen",
    "Gevel renovatie en kozijnvervanging"
  ];

  const renovationTypes = [
    {
      title: "Complete Woning Renovatie",
      description: "Volledige transformatie van uw woning naar moderne standaarden",
      icon: Home,
      details: "Van gedateerde woning naar modern droomhuis. Wij pakken alle aspecten aan: van constructie tot afwerking voor een complete transformatie."
    },
    {
      title: "Badkamer Renovatie",
      description: "Complete vernieuwing van uw badkamer met moderne materialen en praktische indelingen",
      icon: Bath,
      details: "Van kleine aanpassingen tot complete renovaties. Wij zorgen voor een mooie badkamer die perfect bij uw wensen en budget past."
    },
    {
      title: "Keuken Verbouwing",
      description: "Nieuwe keukens die perfect aansluiten bij uw levensstijl en kookgewoonten",
      icon: ChefHat,
      details: "Praktische keukens met goede apparatuur en slimme opbergoplossingen voor optimaal kookplezier."
    }
  ];

  const features = [
    {
      title: "Persoonlijke Oplossingen",
      description: "Elke renovatie is uniek en wordt volledig op maat gemaakt",
      icon: Award
    },
    {
      title: "Minimale Overlast",
      description: "Wij zorgen voor zo min mogelijk overlast tijdens de werkzaamheden",
      icon: Shield
    },
    {
      title: "Heldere Communicatie",
      description: "Duidelijke planning en regelmatige updates over de voortgang",
      icon: Users
    }
  ];
  ...
  const renovationSteps = [
    {
      ...
      description: "Samen bespreken we uw wensen en geven advies over mogelijkheden",
      details: "We luisteren naar uw ideeën en geven praktisch advies over de beste aanpak voor uw renovatie binnen uw budget."
    },
    {
      step: "2",
      title: "Ontwerp & Planning",
      description: "Helder ontwerp en realistische planning van de werkzaamheden",
      details: "Onze specialisten maken een ontwerp dat perfect past bij uw wensen en budget met een duidelijke planning."
    },
    {
      step: "3",
      title: "Voorbereiding",
      description: "Materialen bestellen en werkruimte voorbereiden",
      details: "Wij zorgen voor alle benodigde materialen en bereiden de werkruimte zorgvuldig voor."
    },
    {
      step: "4",
      title: "Uitvoering",
      description: "Vakkundige uitvoering met minimale overlast",
      details: "Vakkundige uitvoering met respect voor uw wooncomfort en dagelijkse routine."
    }
  ];
  ...
  const beforeAfterProjects = [
    {
      title: "Complete Woning Renovatie",
      description: "Van gedateerde woning naar modern droomhuis",
      image: "https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop"
    },
    {
      title: "Keuken Modernisering",
      description: "Klassieke keuken omgetoverd tot moderne kookruimte",
      image: "https://images.pexels.com/photos/1080721/pexels-photo-1080721.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop"
    },
    {
      title: "Uitbouw & Opbouw",
      description: "Extra woonruimte door vakkundige uitbreiding",
  ...
  const projectTypes = [
    { id: 'bathroom', label: 'Badkamer', icon: Bath },
    { id: 'kitchen', label: 'Keuken', icon: ChefHat },
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-brand-400">Renovatie & Verbouwing</span>
              <br />
              Uw Woning Getransformeerd
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
              Van kleine aanpassingen tot complete transformaties. Compleet Dakonderhoud Nederland geeft uw 
              woning een nieuwe uitstraling en functionaliteit met vakkundig werk en persoonlijke aandacht.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              >
                <span>Gratis Renovatie-advies</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Waarom Kiezen Voor <span className="bg-gradient-to-r from-blue-500 to-brand-600 bg-clip-text text-transparent">Compleet Dakonderhoud Nederland Renovatie?</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Met 25+ jaar ervaring in renovaties en verbouwingen weten wij precies hoe we uw woonwensen 
              kunnen realiseren met minimale overlast en een prachtig resultaat. Van constructieve aanpassingen 
              tot complete transformaties, wij zijn uw partner voor elke verbouwing.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Onze <span className="bg-gradient-to-r from-blue-500 to-brand-600 bg-clip-text text-transparent">Renovatie Diensten</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Of het nu gaat om een kleine aanpassing of een complete transformatie, 
              wij hebben de expertise om uw woonwensen waar te maken met vakkundig werk en oog voor detail.
            </p>
          </div>
                  ...
                  <div className="bg-white rounded-xl p-8 shadow-lg">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700">Ontwerp en advies</span>
                      </li>
                      <li className="flex items-center space-x-3">
                        <CheckCircle className="w-5 h-5 text-brand-500 flex-shrink-0" />
                        <span className="text-gray-700">Materialen en installatie</span>
                      </li>
                      <li className="flex items-center space-x-3">
                        <CheckCircle className="w-5 h-5 text-brand-500 flex-shrink-0" />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Ons <span className="bg-gradient-to-r from-blue-500 to-brand-600 bg-clip-text text-transparent">Renovatieproces</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Van eerste gesprek tot oplevering begeleiden wij u persoonlijk 
              door het hele renovatieproces met minimale overlast.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {renovationSteps.map((item, index) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-8">
                Wat Wij Voor U <span className="text-brand-500">Kunnen Doen</span>
              </h2>
              ...
              <div className="mt-8 p-6 bg-brand-50 border border-brand-200 rounded-lg">
                <h4 className="font-bold text-slate-900 mb-2">Onze Visie</h4>
                <p className="text-gray-700">
                  Van kleine reparaties tot complete renovaties. Wij pakken elk project aan met 
                  dezelfde zorg en aandacht voor detail. Of het nu gaat om een uitbouw, opbouw, gevelrenovatie, 
                  of complete woningtransformatie - wij zorgen dat u kunt genieten van uw vernieuwde woning.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg max-w-3xl mx-auto leading-relaxed">
              Klaar om uw renovatie of verbouwing werkelijkheid te maken? Of het nu gaat om een complete 
              woningtransformatie, uitbouw, opbouw of interieurverbouwing - neem contact met ons op 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      >
                        ...
                        <option value="75k+">Boven €75.000</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
