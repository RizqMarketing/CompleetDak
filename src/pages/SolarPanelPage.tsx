...
import { 
  Sun, CheckCircle, Star, Phone, Mail, ArrowRight, 
  Award, Shield, Clock, Users, Calculator, Eye, Zap, Battery, Leaf,
  Send, User, MessageCircle, Calendar, Building2, Home, MapPin
} from 'lucide-react';
...
const SolarPanelPage = () => {
  ...
  const solarServices = [
    ...
    "Omvormers en monitoring",
    "Batterijopslag systemen",
    "Energieadvies op maat",
    "Subsidie begeleiding",
    "Onderhoud en service",
    "Dakcontrole en voorbereiding",
  ...
  const solarBenefits = [
    {
      ...
      description: "Bespaar tot 70% op uw energiekosten met zonnepanelen",
      icon: Zap,
      details: "Met zonnepanelen wekt u uw eigen stroom op, waardoor uw energierekening aanzienlijk daalt. Gemiddeld bespaart u 50-70% op uw jaarlijkse energiekosten."
    },
    {
      title: "Duurzame Investering",
      description: "Rendement van 8-12% per jaar op uw investering",
      icon: Battery,
      details: "Zonnepanelen zijn een slimme investering met een gemiddeld rendement van 8-12% per jaar. De terugverdientijd is gemiddeld 5-7 jaar, terwijl de panelen 25+ jaar meegaan."
    },
    {
      title: "Milieuvriendelijk",
      description: "Verminder uw CO2-uitstoot en draag bij aan een beter milieu",
      icon: Leaf,
      details: "Door over te stappen op zonne-energie vermindert u uw CO2-uitstoot aanzienlijk. Een gemiddeld systeem bespaart ongeveer 1.500 kg CO2 per jaar."
    }
  ];

  const features = [
    {
      title: "Premium Zonnepanelen",
      description: "Hoogwaardige panelen met 25 jaar productgarantie",
      icon: Sun
    },
    {
    ...
    },
    {
      ...
      description: "Maximale energieopbrengst voor optimale kostenbesparing",
      icon: Eye
    }
  ];
  ...
  const solarProcess = [
    {
      ...
      description: "Persoonlijk advies over de mogelijkheden voor uw woning",
      details: "We bespreken uw energieverbruik, dakoppervlak en wensen om een optimaal systeem te ontwerpen."
    },
    {
      step: "2",
      title: "Offerte Op Maat",
      description: "Transparante offerte met alle kosten en opbrengsten",
      details: "U ontvangt een heldere offerte met gedetailleerde informatie over kosten, opbrengsten en terugverdientijd."
    },
    {
      step: "3",
      title: "Professionele Installatie",
      description: "Vakkundige installatie door gecertificeerde monteurs",
      details: "Onze ervaren monteurs installeren uw systeem snel en vakkundig, meestal binnen één dag."
    },
    {
      step: "4",
      title: "Monitoring & Service",
      description: "Monitoring systeem en uitgebreide service na installatie",
      details: "Na installatie krijgt u toegang tot een monitoring systeem en kunt u rekenen op onze service en ondersteuning."
    }
  ];
  ...
  const projectTypes = [
    { id: 'residential', label: 'Woning', icon: Home },
    { id: 'commercial', label: 'Bedrijf', icon: Building2 },
    { id: 'battery', label: 'Met Batterij', icon: Battery }
  ];

  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead 
        title="Zonnepanelen Installatie | Aannemersbedrijf EMT | Bespaar op Energiekosten"
        description="Bespaar tot 70% op uw energierekening met zonnepanelen van Aannemersbedrijf EMT. Professionele installatie, premium panelen en 25 jaar garantie. Vraag nu een gratis offerte aan!"
        keywords="zonnepanelen, zonne-energie, duurzame energie, energiebesparing, groene stroom, zonnepanelen installatie, zonnepanelen Andelst, zonnepanelen Gelderland"
        canonicalUrl="https://aannemersbedrijf-emt.nl/zonnepanelen"
      />
      <Header />
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-20 pt-32">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.pexels.com/photos/9875441/pexels-photo-9875441.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop)'
          }}
        ></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-yellow-400">Zonnepanelen</span>
              <br />
              Bespaar Tot 70% Op Uw Energierekening
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
              Stap over op duurzame zonne-energie en bespaar fors op uw energiekosten. 
              EMT zorgt voor een zorgeloze installatie met premium zonnepanelen en uitgebreide garantie.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              >
                ...
                <span>Direct Advies: 0488 23 40 37</span>
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Waarom Kiezen Voor <span className="text-yellow-400">EMT Zonnepanelen?</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Met 25+ jaar ervaring in de bouw en energiesector zorgen wij voor een zorgeloze 
              overstap naar zonne-energie met premium producten en vakkundige installatie.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative overflow-hidden rounded-xl shadow-lg">
              <img
                ...
                alt="Zonnepanelen op woning"
                className="w-full h-64 object-cover hover:scale-110 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent"></div>
              <div className="absolute bottom-4 left-4 text-white">
                <h4 className="font-bold">Woningen</h4>
                <p className="text-sm">Optimale energiebesparing voor uw huis</p>
              </div>
            </div>
            <div className="relative overflow-hidden rounded-xl shadow-lg">
              <img
                ...
                alt="Zonnepanelen op bedrijfspand"
                className="w-full h-64 object-cover hover:scale-110 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent"></div>
              <div className="absolute bottom-4 left-4 text-white">
                <h4 className="font-bold">Bedrijfspanden</h4>
                <p className="text-sm">Duurzame energieoplossingen voor bedrijven</p>
              </div>
            </div>
            <div className="relative overflow-hidden rounded-xl shadow-lg">
              <img
                src="https://images.pexels.com/photos/2800832/pexels-photo-2800832.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop"
                alt="Batterijopslag systeem"
                className="w-full h-64 object-cover hover:scale-110 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent"></div>
              <div className="absolute bottom-4 left-4 text-white">
                <h4 className="font-bold">Batterijopslag</h4>
                <p className="text-sm">Maximaal profiteren van uw zonne-energie</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Voordelen Van <span className="text-yellow-400">Zonnepanelen</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                    ...
                    {index === 0 && (
                      <ul className="space-y-2">
                        <li className="flex items-center space-x-3">
                          ...
                          <span className="text-gray-700">Lagere maandlasten</span>
                        </li>
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                          <span className="text-gray-700">Bescherming tegen stijgende energieprijzen</span>
                        </li>
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                        ...
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                          <span className="text-gray-700">Minder afhankelijk van energiebedrijven</span>
                        </li>
                      </ul>
                    )}
                    {index === 1 && (
                      <ul className="space-y-2">
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                          <span className="text-gray-700">Stabiel rendement voor lange termijn</span>
                        </li>
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                          <span className="text-gray-700">Waardevaste investering</span>
                        </li>
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                          <span className="text-gray-700">Fiscale voordelen (BTW teruggave)</span>
                        </li>
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                          <span className="text-gray-700">Subsidie mogelijkheden</span>
                        </li>
                      </ul>
                    )}
                    {index === 2 && (
                      <ul className="space-y-2">
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                          <span className="text-gray-700">Aanzienlijke CO2-reductie</span>
                        </li>
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                          <span className="text-gray-700">Schone, hernieuwbare energiebron</span>
                        </li>
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                          <span className="text-gray-700">Bijdrage aan klimaatdoelstellingen</span>
                        </li>
                        <li className="flex items-center space-x-3">
                          <CheckCircle className="w-5 h-5 text-yellow-500 flex-shrink-0" />
                          <span className="text-gray-700">Duurzaam imago voor uw woning of bedrijf</span>
                        </li>
                      </ul>
                    )}
                  </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Ons <span className="text-yellow-400">Zonnepanelen Proces</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Van advies tot installatie en nazorg, wij begeleiden u door het hele proces 
              voor een zorgeloze overstap naar zonne-energie.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {solarProcess.map((item, index) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-8">
                Onze <span className="text-yellow-400">Zonnepanelen Diensten</span>
              </h2>
              ...
              <div className="mt-8 p-6 bg-yellow-50 border border-yellow-200 rounded-lg">
                <h4 className="font-bold text-slate-900 mb-2">Waarom EMT Zonnepanelen?</h4>
                <p className="text-gray-700">
                  Als ervaren aannemersbedrijf hebben wij de expertise om uw zonnepanelen vakkundig te installeren. 
                  Wij zorgen voor een complete service, van advies tot installatie en nazorg.
                </p>
              </div>
            </div>
            <div className="relative">
              <img
                src="https://images.pexels.com/photos/2800832/pexels-photo-2800832.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Antwoorden op de meest gestelde vragen over zonnepanelen en onze diensten.
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            ...
            <button 
              onClick={() => setIsContactPopupOpen(true)}
              className="bg-yellow-500 hover:bg-yellow-600 text-slate-900 font-bold px-8 py-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg inline-flex items-center space-x-2"
            >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Tevreden <span className="text-yellow-400">Klanten</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Met 25+ jaar ervaring hebben wij vele tevreden klanten geholpen met hun bouwprojecten.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6 leading-tight">
              Laten We Uw Zonnepanelen
              <span className="text-yellow-400"> Bespreken</span>
            </h2>
            <p className="text-gray-300 text-lg max-w-3xl mx-auto leading-relaxed">
              Klaar om te besparen op uw energierekening? Neem contact met ons op 
              voor een gratis adviesgesprek en offerte.
            </p>
          </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      >
                        ...
                        <option value="<5k">Onder €5.000</option>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-2xl p-8">
              ...
              <p className="text-slate-800 mb-6 max-w-2xl mx-auto">
                ...
                en ontdek hoeveel u kunt besparen met zonnepanelen.
              </p>
              <a
                href="tel:0488234037"
      ...
      <ContactPopup 
        ...
        service="Zonnepanelen"
        title="Gratis Zonnepanelen Offerte"
      />
    </div>
  );
};
