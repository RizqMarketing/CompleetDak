...
const SolarPanelPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead 
        title="Zonnepanelen Installatie | Compleet Dakonderhoud Nederland | Bespaar op Energiekosten"
        description="Bespaar tot 70% op uw energierekening met zonnepanelen van Compleet Dakonderhoud Nederland. Professionele installatie, premium panelen en 25 jaar garantie. Vraag nu een gratis offerte aan!"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-brand-400">Zonnepanelen</span>
              <br />
              Bespaar Tot 70% Op Uw Energierekening
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
              Stap over op duurzame zonne-energie en bespaar fors op uw energiekosten. 
              Compleet Dakonderhoud Nederland zorgt voor een zorgeloze installatie met premium zonnepanelen en uitgebreide garantie.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Waarom Kiezen Voor <span className="text-brand-400">Compleet Dakonderhoud Nederland Zonnepanelen?</span>
            </h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Voordelen Van <span className="text-brand-400">Zonnepanelen</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Ons <span className="text-brand-400">Zonnepanelen Proces</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-8">
                Onze <span className="text-brand-400">Zonnepanelen Diensten</span>
              </h2>
              ...
              <div className="mt-8 p-6 bg-brand-50 border border-brand-200 rounded-lg">
                <h4 className="font-bold text-slate-900 mb-2">Waarom Compleet Dakonderhoud Nederland Zonnepanelen?</h4>
