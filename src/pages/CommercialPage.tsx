...
const CommercialPage = () => {
  ...
  const benefits = [
    "Kleine tot middelgrote bedrijfspanden",
    "Kantoorruimtes en praktijkpanden", 
  ...
  const features = [
    {
      ...
      description: "Eén aanspreekpunt voor uw complete project van ontwerp tot oplevering",
      icon: Users
    },
    {
      title: "Praktische Oplossingen",
      description: "Functionele gebouwen die perfect aansluiten bij uw bedrijfsbehoeften",
      icon: Award
    },
    {
      title: "Realistische Planning",
      description: "Heldere planning en professionele uitvoering binnen de afgesproken termijn",
      icon: Clock
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-brand-400">Commerciële Bouw</span>
              <br />
              Voor Uw Bedrijf
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
              Van kantoorpanden tot werkplaatsen. Compleet Dakonderhoud Nederland realiseert 
              commerciële projecten die uw bedrijf laten groeien met persoonlijke aandacht.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              >
                <span>Bedrijfspand Offerte</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Waarom Compleet Dakonderhoud Nederland Voor <span className="text-brand-500">Uw Bedrijfspand?</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Wij begrijpen de behoeften van lokale ondernemers en leveren praktische oplossingen 
              die uw bedrijfsdoelen ondersteunen binnen uw budget.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative overflow-hidden rounded-xl shadow-lg">
              <img
                ...
                alt="Klein kantoorgebouw"
                className="w-full h-64 object-cover hover:scale-110 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent"></div>
              <div className="absolute bottom-4 left-4 text-white">
                <h4 className="font-bold">Kantoorpanden</h4>
                <p className="text-sm">Functionele werkruimtes voor ondernemers</p>
              </div>
            </div>
            <div className="relative overflow-hidden rounded-xl shadow-lg">
              <img
                src="https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop"
                alt="Winkelruimte"
                className="w-full h-64 object-cover hover:scale-110 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent"></div>
              <div className="absolute bottom-4 left-4 text-white">
                <h4 className="font-bold">Retail Ruimtes</h4>
                <p className="text-sm">Aantrekkelijke winkels en horecagelegenheden</p>
              </div>
            </div>
            <div className="relative overflow-hidden rounded-xl shadow-lg">
              <img
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent"></div>
              <div className="absolute bottom-4 left-4 text-white">
                <h4 className="font-bold">Werkplaatsen</h4>
                <p className="text-sm">Praktische ruimtes voor productie en reparatie</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Onze <span className="bg-gradient-to-r from-blue-500 to-brand-600 bg-clip-text text-transparent">Specialisaties</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Met 25+ jaar ervaring in commerciële bouw realiseren wij projecten 
              voor lokale ondernemers met focus op functionaliteit en betaalbaarheid.
            </p>
          </div>
            ...
            {sectors.map((sector, index) => (
              <div key={index} className={`flex flex-col lg:flex-row items-center gap-12 ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                <div className="lg:w-1/2">
                  ...
                  <p className="text-gray-700 leading-relaxed">{sector.details}</p>
                </div>
                <div className="lg:w-1/2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-8">
                Uw Voordelen Bij <span className="bg-gradient-to-r from-blue-500 to-brand-600 bg-clip-text text-transparent">Compleet Dakonderhoud Nederland Commerciële Bouw</span>
              </h2>
              ...
              <div className="mt-8 p-6 bg-brand-50 border border-brand-200 rounded-lg">
                <h4 className="font-bold text-slate-900 mb-2">Waarom Ondernemers Kiezen Voor Compleet Dakonderhoud Nederland</h4>
                <p className="text-gray-700">
                  Onze ervaring met commerciële projecten, gecombineerd met lokale kennis en persoonlijke aandacht, 
                  maakt ons de ideale partner voor uw bedrijfspand. Wij denken mee in praktische oplossingen.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg max-w-3xl mx-auto leading-relaxed">
              Klaar om uw commerciële project werkelijkheid te maken? Neem contact met ons op 
