...
import { 
  Building2, CheckCircle, Star, Phone, Mail, ArrowRight, 
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-yellow-400">Commerciële Bouw</span>
              <br />
              Voor Uw Bedrijf
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
              Van kantoorpanden tot werkplaatsen. EMT realiseert 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Waarom EMT Voor <span className="text-yellow-500">Uw Bedrijfspand?</span>
            </h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Onze <span className="text-yellow-500">Specialisaties</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-8">
                Uw Voordelen Bij <span className="text-yellow-500">EMT Commerciële Bouw</span>
              </h2>
              ...
              <div className="mt-8 p-6 bg-yellow-50 border border-yellow-200 rounded-lg">
                <h4 className="font-bold text-slate-900 mb-2">Waarom Ondernemers Kiezen Voor EMT</h4>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Succesverhalen Van <span className="text-yellow-500">Ondernemers</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
